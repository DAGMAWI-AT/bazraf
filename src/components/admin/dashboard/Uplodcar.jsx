...
function Uplodcar() {
  ...
  return (
    <div className='px-4 my-12'>
      ...
      <form onSubmit={handleCarSubmit} className='flex lg:w-[1080px] flex-col flex-wrap gap-4'>
        ...
        <Textarea className='w-full' id='description' type='text' placeholder='Write description of car...' required rows={6} />
